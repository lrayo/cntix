...
export default function ActualizarDatos({setOnChange}) {
  ...
  const handleSubmit = async (e) => {
      ...
      try {
       ...
       if(data){
        ...
        document.getElementById('modalActualizarDatos').close();
  ...
  <div className="flex justify-center">
      <dialog id="modalActualizarDatos" className="modal">

      <div className="modal-box w-11/12 max-w-11/12">
      <div className="p-1 bg-base-100">
        <div className='text-primary text-xl'>Actualizar Datos CSV</div>
      <div>
