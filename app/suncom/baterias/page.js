...
import CrearLeadBateria from "./crearlead";
...
useEffect(() => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const res = await fetch("/api/suncom/baterias");
  ...
  const [colDefs] = useState([
    { field: "nombre_lead", headerName: "Nombre", sortable: true},
    { field: "apellido_lead", headerName: "Apellido", sortable: true},
  
    { field: "fecha_nacimiento", headerName: "Fecha de Nacimiento", valueFormatter: (params) => {return new Date(params.value).toISOString().slice(0, 10).replace("T", " ") }, sortable: true},
    { field: "ingresos_mensuales", headerName: "Ingresos Mensuales", sortable: true},
    ...
    <div style={{ height: 450, width: "100%" }}>
      ...
      <div className="flex gap-4 justify-between pb-4 items-center">
        <Image
            ...
            priority
            />
        <CrearLeadBateria setOnChange={setOnChange}/>
      </div>
